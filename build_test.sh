...
g++ -g -L/usr/local/opt/openssl/lib -I/usr/local/opt/openssl/include -I./src -I./libs -I ./libs/jansson/ -I ./libs/ssound/  -L ./libs/jansson/ -L ./libs/ssound/ -std=c++11 -O3  $source -o $target -Wl,-rpath=./libs/ssound/  -Wl,-rpath=./libs/jansson/ -lpthread -L.  -lssl -lcrypto -lz -luv -ljansson -lssound -lpthread -lev
